                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      ...
                      <Input id="name" placeholder="أحمد محمد" className="rounded-r-none" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      ...
                      <Input id="email" type="email" placeholder="ahmed@example.com" className="rounded-r-none" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      ...
                      <Input id="phone" placeholder="+966 12 345 6789" className="rounded-r-none" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      ...
                      <Input id="address" placeholder="الرياض، المملكة العربية السعودية" className="rounded-r-none" />
                    </div>
                  </div>
                </div>
