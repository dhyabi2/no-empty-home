          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2">
                <li>Customer John Doe redeemed a reward</li>
                <li>New offer "Summer Sale" created</li>
                <li>10 new customers joined the loyalty program</li>
              </ul>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col space-y-2">
                ...
                <Button>View Customer List</Button>
